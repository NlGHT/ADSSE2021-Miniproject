...
with open('./MemoLCSData.csv', 'r') as csvfile:
...
# set y-axis label
ax.set_ylabel("Time (ms)",color="red",fontsize=14)
# twin object for two different y-axis on the sample plot
ax2=ax.twinx()
# make a plot with different y-axis using second axis object
ax2.plot(headers, memory,color="blue",marker="v")
ax2.set_ylabel("Memory (MB)",color="blue",fontsize=14)

ax.title.set_text("Memory usage and time against n (Memoisation)")
